...
import "github.com/tfcolin/dsg"

const (
	HARD_ATT_TECH             = 10 // "攻城"技能编号
	BATTLE_ROUND_MIN          = 20 // 战斗回合限制基数
	BATTLE_ROUND_STEP         = 30 // 战斗回合限制增量 (随战斗规模增加)
	BURN_HURT         float32 = 15 // 战时燃烧伤害
)
...
type Tech struct {
	...
	// dhp: 原始伤害值 value: 技能 value 值; srole: 发动技能的角色, orole: 对方角色;
